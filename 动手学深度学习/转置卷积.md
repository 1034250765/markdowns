...
![这里写图片描述](https://i-blog.csdnimg.cn/blog_migrate/a732ad03cac87b872a85a22fd2b66265.png)
...
![这里写图片描述](https://i-blog.csdnimg.cn/blog_migrate/604bd974287056bc0333a3f78787cad1.png)

我们对这个3 × 3的卷积核进行重新排列，得到了下面这个4 × 16 的卷积矩阵：
![![这里写图片描述](https://i-blog.csdnimg.cn/blog_migrate/f178bd10a13d107c6e4c5b2f14b3417e.png)](https://i-blog.csdnimg.cn/blog_migrate/a5ff520e8fc42eaa5b30e2dd18ebb36e.png)

为了将卷积操作表示为卷积矩阵和输入矩阵的向量乘法，我们将**输入矩阵4 × 4**摊平(flatten)为一个列向量，形状为16 × 1，如下图所示。
![这里写图片描述](https://i-blog.csdnimg.cn/blog_migrate/f178bd10a13d107c6e4c5b2f14b3417e.png)
...
![这里写图片描述](https://i-blog.csdnimg.cn/blog_migrate/7137927e6dc3ba2a0c2caa1115653592.png)





![image-20260111164217420](C:\Users\LYX10\AppData\Roaming\Typora\typora-user-images\image-20260111164217420.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f159aecee181330b5f5cf0f331f85882.png)

把stride调整为2后，计算过程如下：![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/089fb24c583c067910bbf49e5f1acb91.png)

`nn.ConvTranspose2d` 是 PyTorch 中用于实现二维转置卷积的关键模块，它通过逆向的卷积操作实现了特征图的上采样和空间维度的扩大。

**转置卷积**

![image-20260111195804832](C:\Users\LYX10\AppData\Roaming\Typora\typora-user-images\image-20260111195804832.png)
